...
export const FEATURE_SEED = [
  ...
  ["Self-serve no-code setup in minutes", "Customers can create and launch their own Woxza voice agent, upload business information, and make changes without writing code or waiting for a vendor.", ["general"], 15, "live"],
  ["Inbound and outbound calling", "Answer incoming calls and place follow-up, appointment, or lead-reengagement calls.", ["general"], 20, "live"],
  ["Natural multilingual conversations", "Serve callers in English, Hindi, Telugu, Tamil, Kannada, and more, including natural language switching.", ["general"], 30, "live"],
  ...
  ["Business pricing and discount rules", "Use the business's configured prices, discount rules, and minimum-to-maximum order limits, including different terms for different customers or suppliers.", ["pharmacy", "retail", "restaurant", "general"], 22, "live"],
  ["Proactive customer and supplier follow-ups", "Call customers, clients, or suppliers for reorder reminders, confirmations, updates, and information collection.", ["pharmacy", "retail", "restaurant", "general"], 23, "live"],
  ["Call transcripts and recordings", "Record and transcribe calls, with summaries and a dashboard for review, coaching, and improvement.", ["general"], 40, "live"],
  ["Customer, supplier, stock, and order management", "Manage the operational records behind everyday customer conversations, with configured business rules followed consistently.", ["pharmacy", "retail", "restaurant"], 30, "live"],
  ...
  ["CRM integrations", "Connect CRM, calendar, and database systems so agents can use current business context and record actions.", ["general"], 160, "live"],
  ["Calendar booking integrations", "Book appointments in a connected calendar and update the CRM during the call.", ["booking", "events", "insurance"], 10, "live"],
  ...
  ["Automatic CRM updates and escalations", "Update connected CRM records and hand complex or high-value calls to the right team member with context.", ["general"], 210, "live"],
  ["Data privacy and access control", "Business data, transcripts, and calls are encrypted in transit and at rest, isolated by account, and protected with role-based access controls. Woxza is built with India’s DPDP Act in mind.", ["general"], 35, "live"],
  ["Business-controlled knowledge", "Connect live systems or upload catalog, pricing, and FAQ information, then update product availability and agent behavior yourself.", ["pharmacy", "retail", "restaurant", "general"], 25, "live"],
