...
.popup-content{display:grid;gap:14px;padding:46px 32px 30px;color:var(--woxza-heading)}.eyebrow{color:var(--woxza-accent);font-size:10px;font-weight:800;letter-spacing:.16em}.popup-content h2{max-width:340px;margin:0;color:var(--woxza-heading)!important;-webkit-text-fill-color:var(--woxza-heading);font-size:clamp(27px,4vw,34px);line-height:1.06;letter-spacing:-.045em}.popup-content>p{max-width:340px;margin:0;color:#475569;font-size:14px;line-height:1.6}.popup-content input{width:100%;min-height:50px;padding:0 15px;border:1px solid rgba(var(--woxza-accent-rgb),.26);border-radius:9px;color:var(--woxza-heading);background:var(--woxza-white);font:inherit;outline:none}.popup-content input::placeholder{color:#64748b}.popup-content input:focus{border-color:var(--woxza-accent);box-shadow:0 0 0 4px rgba(var(--woxza-accent-rgb),.14)}.join-button{min-height:50px;display:flex;align-items:center;justify-content:center;gap:9px;border:0;border-radius:9px;color:var(--woxza-white);background:var(--woxza-accent);font:inherit;font-weight:800;cursor:pointer;transition:background .2s,transform .2s}.join-button:hover{background:#1d4ed8;transform:translateY(-1px)}.popup-content small{color:#475569;font-size:10px;line-height:1.45}.sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}
