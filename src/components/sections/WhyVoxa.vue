<template>
  <section id="why-voxa" class="why-section">
    <div class="why-container">
      <header class="section-header">
        <div class="header-title">
          <span class="section-badge">Why Voxa</span>
          <h2>Beyond the <span>conversation</span></h2>
        </div>
        <div class="header-bottom">
          <p>See how Voxa understands every caller, responds naturally and completes the real work behind the call.</p>
        </div>
      </header>
      ...
      <article class="featured-card">
        ...
        <div class="featured-copy">
          ...
          <div class="featured-footer">
            <span>Voxa is handling this now</span>
...
import { ArrowUpRight,Boxes,ChartNoAxesCombined,Grid2X2,LockKeyhole,Network,PhoneForwarded,RefreshCw,ShieldCheck,Zap } from "lucide-vue-next"
...
const capabilities = [
  ...
  { title:"Real-time business data",description:"Every answer uses what is true now.",longDescription:"Voxa reads live availability, pricing and customer context during the call, so every answer reflects what is true at that exact moment.",category:"Live data",color:"#2c6854",icon:RefreshCw },
  { title:"Fits your existing systems",description:"Your stack stays connected.",longDescription:"Calendar, CRM, databases, email and messaging work as one connected system. Voxa updates each tool without forcing you to replace anything.",category:"Integrations",color:"#3157a3",icon:Grid2X2 },
  { title:"No missed calls or follow-ups",description:"Every caller keeps moving.",longDescription:"Every inbound call is answered instantly. Requests, confirmations and follow-ups keep moving without hold music or forgotten notes.",category:"Availability",color:"#1f6773",icon:PhoneForwarded },
  { title:"Acts during the call",description:"The next step happens immediately.",longDescription:"Voxa books appointments, updates records and triggers the next workflow while the customer is still speaking—not hours after the call ends.",category:"Automation",color:"#3752a4",icon:Zap },
  { title:"Gets smarter with every miss",description:"Gaps become permanent improvements.",longDescription:"When Voxa needs help, it hands off cleanly and flags the missing knowledge. Fix it once and the improvement becomes part of every future call.",category:"Learning",color:"#415a84",icon:ChartNoAxesCombined }
]
