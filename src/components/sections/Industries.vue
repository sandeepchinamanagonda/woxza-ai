...
v-for="item in industry.features"
...
(current.value+i+industries.length)

%

industries.length

result.push(industries[index])
...
(current.value-1+industries.length)
...
animation:cardFade .65s ease forwards;
...
0 45px 120px rgba(37,99,235,.22);
